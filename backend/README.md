...
| Install band's Play badge and schema `downloadUrl` | `landing.play_store_url()` ← `PLAY_STORE_URL`; unset, the badge renders inert as শীঘ্রই আসছে and no `downloadUrl` is emitted |
