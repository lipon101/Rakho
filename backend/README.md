...
| Install band's action and schema `downloadUrl` | `landing.play_store_url()` ← `PLAY_STORE_URL`; unset, the band offers the free API key and no `downloadUrl` is emitted |
