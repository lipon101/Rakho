...
import bd.rakho.pharmacy.ui.nav.RakhoRoot
import bd.rakho.pharmacy.ui.theme.RakhoTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun containerReady(): Boolean =
        runCatching { bd.rakho.pharmacy.di.ContainerHolder.get().ready.value }.getOrDefault(false)
